...
class GenerateVolumeImageScript(SessionBasedScript):
    ...
    def setup_args(self):
        ...
        self.add_param('--input_path', type=str, help=('Input path'))
        self.add_param('--output_path', type=str, help=('Output path'))
        self.add_param('--fname_stem', type=str, help=('Filename stem'))
